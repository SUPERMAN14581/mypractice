fetch('https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=24&key=AIzaSyCt-7BNhBifrvrNviItFif36rrq8eFWacY ')
.then((res) => {
return res.json();
}).then((data) =>{
    ...
    for (let i = 0; i <video_list.length; i++) {
        ...
        anchor_elem.href = `details.html?id=${video_id}`
